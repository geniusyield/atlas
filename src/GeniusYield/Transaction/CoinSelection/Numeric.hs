...
Originally from: [@Cardano.Numeric.Util@](https://github.com/cardano-foundation/cardano-wallet/blob/master/lib/numeric/src/Cardano/Numeric/Util.hs).
...
-}
module GeniusYield.Transaction.CoinSelection.Numeric (
  -- * Coalescing values
  padCoalesce,
