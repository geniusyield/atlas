...
import           GeniusYield.Types.Era         (ConwayEra)
...
delegateeToLedger :: GYDelegatee -> Ledger.Delegatee (Api.EraCrypto ConwayEra)
...
delegateeFromLedger :: Ledger.Delegatee (Api.EraCrypto ConwayEra) -> GYDelegatee
