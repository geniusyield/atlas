...
mockMint :: (Map (GYBuildScript 'PlutusV2) (Map GYTokenName Integer, GYRedeemer))
mockMint = mockMint' 10

mockBurn :: (Map (GYBuildScript 'PlutusV2) (Map GYTokenName Integer, GYRedeemer))
mockBurn = mockMint' (-10)

mockMint' :: Integer -> Map (GYBuildScript 'PlutusV2) (Map GYTokenName Integer, GYRedeemer)
mockMint' n = Map.singleton mockMintingPolicy (Map.singleton mockTokenName n, unitRedeemer)

mockMintSum :: (Map (GYBuildScript 'PlutusV2) (Map GYTokenName Integer, GYRedeemer))
mockMintSum = Map.singleton mockMintingPolicy (Map.fromList [(mockTokenName, 10), (mockTokenName1, 20)], unitRedeemer)

mockMintingPolicy :: GYBuildScript 'PlutusV2
mockMintingPolicy = GYBuildPlutusScript $ GYBuildPlutusScriptInlined $ mintingPolicyFromApi @'PlutusV2 $ scriptToApi $ fromJust $ scriptFromCBOR @'PlutusV2 ""
