...
mockMint :: (Map (Some GYMintingPolicy) (Map GYTokenName Integer, GYRedeemer))
mockMint = mockMint' 10

mockBurn :: (Map (Some GYMintingPolicy) (Map GYTokenName Integer, GYRedeemer))
mockBurn = mockMint' (-10)

mockMint' :: Integer -> Map (Some GYMintingPolicy) (Map GYTokenName Integer, GYRedeemer)
mockMint' n = Map.singleton (mkSome mockMintingPolicy) (Map.singleton mockTokenName n, unitRedeemer)
