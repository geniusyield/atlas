...
import qualified Data.Text                         as Text (Text, pack, replace,
                                                            unpack)
import           Test.Tasty
...
import           GeniusYield.Providers.Maestro     (utxoFromMaestro)
...
providersTests :: [GYCoreConfig] -> TestTree
providersTests configs = testGroup "Providers" [ testGroup "Maestro" maestroTests, providersMashupTests configs ]

maestroTests :: [TestTree]
maestroTests =
    [ testGroup "Maestro.Utxo to GYUTxO translation"
